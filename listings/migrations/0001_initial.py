    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('Beginner', 'Beginner'), ('Middle', 'Middle'), ('Expert', 'Expert')], default='Beginner', max_length=50)),
                ...
                ('freelancer', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='freelancers.freelancer')),
            ],
        ),
    ]
